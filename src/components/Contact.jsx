...
const Contact = () => {
  return (
    ...
    <form >
        <div
            className="max-w-screen-xl mt-0 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
            <div className="flex flex-col justify-between" data-aos="fade-down"
     data-aos-easing="linear"
     data-aos-duration="1500">
                <div >
                    <h2 className="text-4xl lg:text-5xl font-bold leading-tight">Lets talk about everything!</h2>
                    <div className="text-gray-700 mt-8">
                        Send us an email instead <span className="underline"><a target="_BLANK"
                                href="mailto:ammad8322@gmail.com">ammad8322@gmail.com</a></span>
                    </div>
                </div>
                <div className="mt-8 text-center">
                    <svg className="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
     ...
     data-aos-duration="1500">
                <div>
                    ...
                    <input name="fullname"
                        ...
                        type="text" placeholder=""  id="fullname" required />
                </div>
                <div className="mt-8">
                ...
                <div className="mt-8">
                    ...
                    <textarea name="message"
                        className="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" id="messsage"  type="text"></textarea>
                </div>
                <div className="mt-1">
                    <div className="p-4 border-t mx-8 mt-2">
                        <button className="w-full block mx-auto work-button" type="submit" value="submit" id="submit">Send Message</button>
                    </div>
                </div>
            </div>
        </div>
